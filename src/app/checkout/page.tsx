      ...
      <div className="max-w-6xl mx-auto px-6 pb-20">
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 mb-6">
              {cart.map((item) => {
                ...
                return (
                  <div
                    key={key}
                    className={`flex gap-4 items-center p-3 rounded-sm border border-sand/60 bg-white/40 transition-all duration-300 ${
                      isRemoving
                        ? "opacity-0 scale-95"
            ...
            {/* Bill Summary */}
            <div className="border border-sand rounded-sm p-4 bg-sand/10">
              ...
              <div className="flex flex-col gap-2.5 text-sm">
                <div className="flex justify-between text-charcoal/70">
                  <span>
                    Subtotal ({cart.reduce((acc, i) => acc + i.qty, 0)} items)
                  </span>
            ...
            <div className="mt-6 bg-sand/40 rounded-sm p-4 text-xs text-muted space-y-2">
              ...
              <p>For any inquiry Call On +919737018077</p>
            </div>
          </div>
        </div>
      </div>
