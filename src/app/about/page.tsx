          ...
          {[
            {
              step: "01",
              title: "Source",
              desc: "We visit artisans across India — Kutch, Jaipur, Varanasi, Bengal — and select only the finest handmade fabrics.",
            },
            {
              step: "02",
              title: "Design",
              desc: "Our team in Anand designs minimal, clean silhouettes that honour the fabric without overwhelming it.",
            },
            {
              step: "03",
              title: "Craft",
            ...
            <div
              key={item.step}
              className={`relative flex gap-8 mb-12 ${i % 2 === 0 ? "flex-row" : "flex-row-reverse"}`}
            >
