  ...
  if (cart.length === 0) {
    return (
      <div className="bg-cream min-h-screen pt-28 flex flex-col items-center justify-center gap-6">
        ...
        <Link
          href="/shop"
          className="btn-gold text-xs uppercase tracking-widest text-white px-8 py-3 rounded-sm mt-2"
        >
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            {cart.map((item) => (
              <div
                ...
                className="flex gap-5 pb-6 border-b border-sand"
              >
                ...
                <div className="flex flex-col justify-between flex-1">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <div className="flex items-center border border-charcoal/20 rounded-sm">
                      ...
                      <span className="px-3 text-sm text-charcoal font-medium">
                        {item.qty}
                      </span>
                      <button
                        onClick={() =>
            ...
            <button
              onClick={clearCart}
              className="self-start text-xs text-muted uppercase tracking-widest underline underline-offset-4 hover:text-charcoal transition-colors mt-2"
            >
              Clear Cart
            </button>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-sand/40 border border-sand rounded-sm p-6 sticky top-28">
              ...
              <Link
                href="/checkout"
                className="btn-gold block text-center text-xs uppercase tracking-widest text-white px-6 py-4 rounded-sm mt-8"
              >
                Proceed to Checkout
              </Link>
